...
The natural reaction for many (especially when under stress) is to desperately click "Format" or hit "Cancel" and immediately run disk-checking software like Chkdsk. **Stop immediately!** This reflex is the fastest way to destroy any chance of recovering your data forever.
